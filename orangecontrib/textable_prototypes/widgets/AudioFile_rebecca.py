...
class AudioFile(OWTextableBaseWidget):
    ...
    def get_large_audio_transcription(self, path, language, set_silence_len=500, set_silence_threshold=14):
        ...
        # Initiate ouput variables
        whole_text = ""
        segments = list()
        # Initiate an alert message and a progress bar
    ...
    def sendData(self):
        ...
        # Concatenate the segmentations in the output segmentation
        ...
        # Send the segmentation's length
